...
async function main() {
    try {
       ...
       // await contract.submitTransaction('changeCarOwner', 'DEVICE1', 'English-korean');
       await contract.submitTransaction('transaction','DEVICE1','DEVICE2');
	await contract.submitTransaction('skillShare','DEVICE1','DEVICE2');
	//await contract.submitTransaction('createswarm_d','DEVICE1','300','3','Mandarin','70')	
