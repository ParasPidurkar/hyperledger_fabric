...
exports.retreiveHistory = async function (Callback,userName,orgNo) {
...
//console.log("Tag0.4")
  ...
  //      console.log("Tag1");
        const result = await contract.evaluateTransaction('retreiveHistory',userName);
    //    console.log("Tag2");
